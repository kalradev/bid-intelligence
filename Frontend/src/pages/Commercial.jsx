...
const Commercial = () => {
  ...
  useEffect(() => {
    ...
    const key = `riskAreas_user_commercial_${projectName}_${documentId ?? ""}`;
    try {
  ...
  useEffect(() => {
    ...
    localStorage.setItem(`riskAreas_user_commercial_${projectName}_${documentId ?? ""}`, JSON.stringify(userRiskAreas));
