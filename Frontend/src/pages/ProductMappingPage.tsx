...
export default function ProductMappingPage() {
  ...
  const productsMapped = productMapping.productsMapped || "N/A";
  const miiStatus = productMapping.makeInIndiaMapping?.status || "N/A";
  const miiMapped = productMapping.makeInIndiaMapping?.mapped || 0;
  const miiUnmapped = productMapping.makeInIndiaMapping?.unmapped || 0;
  const miiProductStatus = productMapping.miiProductStatus || [];

  // Calculate MII compliance percentage
  let miiCompliance = "0%";
